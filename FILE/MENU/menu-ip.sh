...
APIGIT=$(cat /etc/Pujianto1219/github/api)
EMAILGIT=$(cat /etc/Pujianto1219/github/email)
USERGIT=$(cat /etc/Pujianto1219/github/username)
...
if [[ -f /etc/Pujianto1219/github/api && -f /etc/Pujianto1219/github/email && /etc/Pujianto1219/github/username ]]; then
   rec="OK"
else
    mkdir /etc/Pujianto1219/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/Pujianto1219/github/email
echo "$USERNAME1" > /etc/Pujianto1219/github/username
echo "$API1" > /etc/Pujianto1219/github/api
echo "ON" > /etc/Pujianto1219/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/Pujianto1219/github/email
rm -f /etc/Pujianto1219/github/username
rm -f /etc/Pujianto1219/github/api
rm -f /etc/Pujianto1219/github/gitstat
echo "OFF" > /etc/Pujianto1219/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/Pujianto1219/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/Pujianto1219/github
    touch /etc/Pujianto1219/github/gitstat
    echo "OFF" > /etc/Pujianto1219/github/gitstat
fi

stst1=$(cat /etc/Pujianto1219/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
stst=$(cat /etc/Pujianto1219/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
