...
sleep 3
mkdir -p /etc/Pujianto1219
mkdir -p /etc/Pujianto1219/theme
mkdir -p /var/lib/Pujianto1219-pro >/dev/null 2>&1
echo "IP=" >> /var/lib/Pujianto1219-pro/ipvps.conf
...
echo ""
wget -q https://raw.githubusercontent.com/Pujianto1219/ScAcil/main/FILE/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
echo "IP=$pp" > /var/lib/Pujianto1219-pro/ipvps.conf

#THEME RED
cat <<EOF>> /etc/Pujianto1219/theme/red
BG : \E[40;1;41m
TEXT : \033[0;31m
EOF
#THEME BLUE
cat <<EOF>> /etc/Pujianto1219/theme/blue
BG : \E[40;1;44m
TEXT : \033[0;34m
EOF
#THEME GREEN
cat <<EOF>> /etc/Pujianto1219/theme/green
BG : \E[40;1;42m
TEXT : \033[0;32m
EOF
#THEME YELLOW
cat <<EOF>> /etc/Pujianto1219/theme/yellow
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME MAGENTA
cat <<EOF>> /etc/Pujianto1219/theme/magenta
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME CYAN
cat <<EOF>> /etc/Pujianto1219/theme/cyan
BG : \E[40;1;46m
TEXT : \033[0;36m
EOF
#THEME CONFIG
cat <<EOF>> /etc/Pujianto1219/theme/color.conf
blue
EOF
...
sleep 2
clear
wget https://raw.githubusercontent.com/Pujianto1219/ScAcil/main/FILE/SSH/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
clear
echo -e "${purple}--------------------------${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/Pujianto1219/ScAcil/main/FILE/XRAY/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/Pujianto1219/ScAcil/main/FILE/WEBSOCKET/insshws.sh && chmod +x insshws.sh && ./insshws.sh
#Install AutoBackup
clear
echo -e "${purple}---------------------------------${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/Pujianto1219/ScAcil/main/backups/set-br.sh && chmod +x set-br.sh && ./set-br.sh
#Download Extra Menu
clear
echo -e "${purple}------------------------------${NC}"
...
echo -e "${purple}------------------------------${NC}"
sleep 2
wget https://raw.githubusercontent.com/Pujianto1219/ScAcil/main/FILE/MENU/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Pujianto1219/ScAcil/main/FILE/version  )
